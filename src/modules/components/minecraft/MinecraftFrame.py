...
def create(ctk, master):
    ...
    # Create components
    logbox = LogBox.create(ctk, frame)
    ...
    update = UpdateButton.create(ctk, frame, instance, executable, logbox, updater.start)

    # Position components
    logbox.grid(row=0, columnspan=2, pady=(20, 5), padx=10, sticky="nsew")
